          ...
          <Slider className=" d-lg-none" {...settings}>
            ...
            <div className="bg_gradient">
              <div className="boxTravelWithUs ">
                ...
                <p className=" mb-0 text-sm-center mt-2 fs_xsm clr_blue font_poppins fw-normal ">
                  From group trips to custom tours exploring diverse landscapes,
                  cultures & lots more.
                </p>
              </div>
            </div>
            ...
            <div className="bg_gradient">
              <div className="boxTravelWithUs ">
                <span className=" d-flex align-items-center flex-column flex-sm-row gap-2 gap-sm-4">
                  <Image height={80} width={80} src={mountains_img} alt="img" />
                  <p className=" fs_lg clr_blue fw-semibold font_poppins mb-0">
                    Trip Itineraries Curated with Love
                  </p>
                </span>
                <p className=" mb-0 text-sm-center mt-2 fs_xsm clr_blue font_poppins fw-normal ">
                  Trip plans handcrafted by destination experts for hassle-free
                  travel experience.
                </p>
              </div>
            </div>
            ...
            <div className="bg_gradient">
              <div className="boxTravelWithUs ">
                ...
                <p className=" mb-0 text-sm-center mt-2 fs_xsm clr_blue font_poppins fw-normal ">
                  Our growth lies in the memorable travel experiences we provide
                  to our travellers.
                </p>
              </div>
            </div>
            <div className="bg_gradient">
              <div className="boxTravelWithUs ">
                ...
                <p className=" mb-0 text-sm-center mt-2 fs_xsm clr_blue font_poppins fw-normal ">
                  Seamless booking process on all our trips with the help or our
                  travel experts.
                </p>
              </div>
            </div>
            <div className="bg_gradient">
              <div className="boxTravelWithUs ">
                ...
                <p className=" mb-0 text-sm-center mt-2 fs_xsm clr_blue font_poppins fw-normal ">
                  We make sure to bring only like-minded travellers on basis of
                  age, gender, comfort etc.
                </p>
              </div>
            </div>
            <div className="bg_gradient">
