              ...
              <div id="Itinerary" className="border_box p-4  mt-4">
                ...
                {/* <Accordion className=" mt-4" defaultActiveKey={["0"]}>
                  <Accordion.Item eventKey="0" className=" mb-4 ">
                    <Accordion.Header>
                      {" "}
                      <p className="  bg_blue  rounded_5 py-2 px-3 me-2 me-sm-3 mb-0 mb-sm-0 d-inline-block font_poppins fw-medium fs_sm fs_7 text-center text-white">
                        {" "}
                        Day 0
                      </p>{" "}
                    ...
                    <Accordion.Body>
                      <p className=" mb-0 fw-medium fs_xsm text-black font_poppins d-flex gap-2">
                        <span>&#x2022;</span> Wake up early in the morning and
                        post breakfast, drive from Kalpa to Nako/Tabo village -
                        home to the oldest Buddhist monastery located in Spiti
                        Valley.
                      </p>
                      <p className=" mb-0 fw-medium fs_xsm text-black font_poppins d-flex gap-2 mt-2">
                        <span> &#x2022;</span> Get mesmerized by the
                        shape-shifting landscapes of mountains with every turn.
                      </p>
                      <p className=" mb-0 fw-medium fs_xsm text-black font_poppins d-flex gap-2 mt-2 ">
                        <span> &#x2022;</span> En route we will take a halt at
                        Khab Sangam, visit the famous Nako Lake and monastery
                        and Gue village to see from your naked eyes the
                        500-year-old mummified remains of the Buddhist monk
                        Sangha Tenzin.
                      </p>
                      <p className=" mb-0 fw-medium fs_xsm text-black font_poppins d-flex gap-2 mt-2">
                        <span> &#x2022;</span> After arriving in Nako/Tabo
                        village, check in to our comfy hotel/homestay and have
                        some leisure.
                      </p>
                      <p className=" mb-0 fw-medium fs_xsm text-black font_poppins d-flex gap-2 mt-2">
                        <span> &#x2022;</span> Savour home-style cooked dinner
                        and overnight stay in a hotel/homestay.
                      </p>
                      <div className=" row p-2 p-sm-3 rounded-3 bg-light mt-3 -flex  align-items-center ">
                        <div className="d-none d-sm-flex mb-4 col-lg-3">
                          {" "}
                          <p className="  text-black fw-medium fs_xsm font_poppins mb-0">
                            Inclusions:
                          </p>
                        </div>
                        <div className=" col-4 col-sm-6 col-md-4 col-lg-3 flex-column flex-md-row d-flex align-items-center  mt-sm-3 gap-1 gap-sm-2">
                          <Image
                            className="  w_40 "
                            src={breakfast}
                            alt="breakfast"
                          />
                          <article className=" text-center text-sm-start">
                            <p className=" font_poppins fw-semibold fs_sm fs_9 text-black mb-0">
                              Breakfast
                            </p>
                            <p className=" font_poppins fw-medium fs_xsm fs_9 text-success mb-0">
                              Included
                            </p>
                          </article>
                        </div>
                        <div className=" col-4 col-sm-6 col-md-4 col-lg-3 flex-column flex-md-row d-flex align-items-center mt-sm-3 gap-1 gap-sm-2">
                          <Image className="  w_40 " src={lunch} alt="lunch" />
                          <article className=" text-center text-sm-start">
                            <p className=" font_poppins fw-semibold fs_sm fs_9 text-black mb-0">
                              Lunch
                            </p>
                            <p className=" font_poppins fw-medium fs_xsm fs_9 text-danger white_space mb-0">
                              Not Included
                            </p>
                          </article>
                        </div>
                        <div className=" col-4 col-sm-6 col-md-4 col-lg-3 flex-column flex-md-row d-flex align-items-center mt-sm-3 gap-1 gap-sm-2">
                          <Image className="  w_40 " src={dinner} alt="Dinner" />
                          <article className=" text-center text-sm-start">
                            <p className=" font_poppins fw-semibold fs_sm fs_9 text-black mb-0">
                              Dinner
                            </p>
                  ...
                  <Accordion.Item eventKey="5" className=" mb-4 ">
                    <Accordion.Header>
                      ...
                      <p className=" mb-0 fw-medium fs_sm font_poppins fs_12 text-black">
                        Exploring Langza, Komic & Hikkim Villages | Kaza -
                        Cafes...
                      </p>
                    </Accordion.Header>
                    <Accordion.Body>
                  ...
                  <Accordion.Item eventKey="6">
                    <Accordion.Header>
                      ...
                      <p className=" mb-0 fw-medium fs_sm font_poppins fs_12 text-black">
                        Key Monastery | Kibber & Chicham | Chandratal Stargaz...
                      </p>
                    </Accordion.Header>
                    <Accordion.Body>
                      <p className=" mb-0 fw-medium fs_xsm text-black font_poppins d-flex gap-2">
